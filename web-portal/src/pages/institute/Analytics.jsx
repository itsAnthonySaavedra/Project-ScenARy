        ...
        <div>
            <div className={dashboardStyles.statsGrid}>
                <div className={dashboardStyles.statCard}>
                    <div className={dashboardStyles.statIcon}><i className="fa-solid fa-users"></i></div>
                ...
                <div className={dashboardStyles.statCard}>
                    <div className={dashboardStyles.statIcon}><i className="fa-solid fa-clock"></i></div>
                    <div className={dashboardStyles.statInfo}>
                        <h3>Avg. Time</h3>
            ...
            <div className={`${dashboardStyles.chartCard} ${dashboardStyles.fullWidth}`}>
                ...
                <div className={dashboardStyles.chartContainer}>
                    <Line data={engagementData} options={{ ...options, maintainAspectRatio: false }} />
                </div>
            </div>
        </div>
    );
