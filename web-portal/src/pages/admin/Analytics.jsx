...
import { formatAnalyticsDate, formatDuration, getRatingStats, getUserAnalyticsMetrics, loadFeedback, loadUserAnalytics, removeFeedback } from "../../lib/userAnalytics";
...
const AdminAnalytics = () => {
    ...
    const totalInteractions = selectedRows.reduce((total, item) => total + Number(item.interactionCount || 0), 0);
